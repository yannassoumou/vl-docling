...
def openai_compatible_vlm_options(
    ...
    Args:
        ...
        hostname_and_port: e.g. "localhost:2222" or "YOUR_TAILSCALE_IP:2222"
...
class DoclingPDFProcessor:
    ...
    def __init__(
        self,
        api_url: str = "YOUR_TAILSCALE_IP:2222",
        ...
        Args:
            api_url: Granite API hostname:port (e.g., "YOUR_TAILSCALE_IP:2222")
...
processor = DoclingPDFProcessor(
    api_url="YOUR_TAILSCALE_IP:2222",
