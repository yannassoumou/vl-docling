...
document_processing:
  pdf:
    ...
    mode_2:
      ...
      api_url: "http://YOUR_TAILSCALE_IP:2222/v1/chat/completions"
...
1. **IBM Granite VL API Server**: Must be running and accessible
   - Default endpoint: `http://YOUR_TAILSCALE_IP:2222/v1/chat/completions`
...
curl http://YOUR_TAILSCALE_IP:2222/v1/models
```
